"""In-memory persistence for the Brand Strategy Engine.
...
class ReportStorage:
    ...
    def __init__(self) -> None:
        self.by_id: dict[BrandReportId, BrandStrategyReport] = {}
        self.by_lineage: dict[BrandReportLineageId, list[BrandStrategyReport]] = {}


class InMemoryBrandReportRepository:
    """Dict-backed :class:`BrandReportRepository`."""
...
class InMemoryUnitOfWork:
    ...
    def __init__(self, storage: ReportStorage) -> None:
        self.reports = InMemoryBrandReportRepository(storage)
