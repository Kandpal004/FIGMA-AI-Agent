...
from design_language.application.ports.specification_repository import (
    DesignLanguageSpecificationRepository,
)
...
class UnitOfWork(Protocol):
    ...
    specifications: DesignLanguageSpecificationRepository
