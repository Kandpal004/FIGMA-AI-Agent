"""In-memory persistence for the Design Language Engine.
...
class SpecificationStorage:
    ...
    def __init__(self) -> None:
        self.by_id: dict[DesignLanguageSpecId, DesignLanguageSpecification] = {}
        self.by_lineage: dict[
            DesignLanguageSpecLineageId, list[DesignLanguageSpecification]
        ] = {}


class InMemorySpecificationRepository:
    """Dict-backed :class:`DesignLanguageSpecificationRepository`."""
