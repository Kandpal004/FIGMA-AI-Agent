...
from design_system.application.ports.specification_repository import (
    DesignSystemSpecificationRepository,
)
...
class UnitOfWork(Protocol):
    ...
    specifications: DesignSystemSpecificationRepository
