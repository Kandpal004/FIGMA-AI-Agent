"""In-memory persistence for the Design System Engine.
...
class SpecificationStorage:
    ...
    def __init__(self) -> None:
        self.by_id: dict[DesignSystemSpecId, DesignSystemSpecification] = {}
        self.by_lineage: dict[
            DesignSystemSpecLineageId, list[DesignSystemSpecification]
        ] = {}


class InMemorySpecificationRepository:
    """Dict-backed :class:`DesignSystemSpecificationRepository`."""
