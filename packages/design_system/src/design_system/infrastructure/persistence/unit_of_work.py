"""SQLAlchemy unit of work for the Design System Engine.

Opens a session (and transaction) per ``async with``, binding the specification repository to it
— used for writes (persisting a specification) and the facade's reads.
"""
...
from design_system.infrastructure.persistence.repositories import (
