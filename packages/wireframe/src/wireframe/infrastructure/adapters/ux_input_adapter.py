"""UXInputAdapter — feeds Phase-10 UX Strategy into the wireframe plan.
...
navigation, and friction into :class:`RawSignal` s (provenance ``UX_STRATEGY``), so section
order and interaction requirements execute the UX strategy. The wireframe domain never imports
    ...
    async def gather(self, project: ProjectContext) -> Sequence[RawSignal]:
        ...
        signals: list[RawSignal] = [
            ...
            RawSignal(
                ...
                source_name="UX Strategy", tags=("navigation", "nav", "structure", "menu"),
            ),
        ]
