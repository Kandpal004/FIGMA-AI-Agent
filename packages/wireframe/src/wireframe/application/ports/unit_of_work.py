...
A unit of work exposes the plan repository bound to a single transaction, opened per
...
from wireframe.application.ports.plan_repository import WireframePlanRepository
...
class UnitOfWork(Protocol):
    """A transactional scope exposing the plan repository."""

    plans: WireframePlanRepository
