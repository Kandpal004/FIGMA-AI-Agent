"""In-memory persistence for the Business Strategy Engine.
...
__all__ = [
    "InMemoryStrategyReportRepository",
    "InMemoryUnitOfWork",
    "ReportStorage",
    "SystemClock",
...
class ReportStorage:
    ...
    def __init__(self) -> None:
        self.by_id: dict[StrategyReportId, BusinessStrategyReport] = {}
        self.by_lineage: dict[
            StrategyReportLineageId, list[BusinessStrategyReport]
        ] = {}


class InMemoryStrategyReportRepository:
    """Dict-backed :class:`StrategyReportRepository`."""
...
class InMemoryUnitOfWork:
    ...
    def __init__(self, storage: ReportStorage) -> None:
        self.reports = InMemoryStrategyReportRepository(storage)
