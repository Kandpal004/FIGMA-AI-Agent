"""In-memory persistence for the Information Architecture Engine.
...
class ReportStorage:
    ...
    def __init__(self) -> None:
        self.by_id: dict[IAReportId, IAReport] = {}
        self.by_lineage: dict[IAReportLineageId, list[IAReport]] = {}


class InMemoryIAReportRepository:
    """Dict-backed :class:`IAReportRepository`."""
...
class InMemoryUnitOfWork:
    ...
    def __init__(self, storage: ReportStorage) -> None:
        self.reports = InMemoryIAReportRepository(storage)
