...
__all__ = ["Base", "ComponentSpecificationModel"]


class Base(DeclarativeBase):
    """Declarative base for the Component Intelligence ORM models."""


class ComponentSpecificationModel(Base):
    """One produced component-composition specification version."""
