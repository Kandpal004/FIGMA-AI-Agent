"""SQLAlchemy unit of work for the Creative Director Engine.

Opens a session (and transaction) per ``async with``, binding the review repository to it —
used for writes (persisting a review) and the facade's reads.
"""
...
from creative_director.infrastructure.persistence.repositories import SqlAlchemyReviewRepository
