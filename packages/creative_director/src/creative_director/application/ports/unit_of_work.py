...
A unit of work exposes the review repository bound to a single transaction, opened per
...
from creative_director.application.ports.review_repository import (
    CreativeDirectorReviewRepository,
)
...
class UnitOfWork(Protocol):
    """A transactional scope exposing the review repository."""

    reviews: CreativeDirectorReviewRepository
