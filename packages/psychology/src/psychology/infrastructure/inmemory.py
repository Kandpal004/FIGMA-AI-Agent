"""In-memory persistence for the Customer Psychology Engine.

A system clock and a dict-backed report store + unit of work, so the engine runs and is
...
__all__ = [
    "InMemoryPsychologyReportRepository",
    "InMemoryUnitOfWork",
    "ReportStorage",
    "SystemClock",
...
class ReportStorage:
    ...
    def __init__(self) -> None:
        self.by_id: dict[PsychologyReportId, CustomerPsychologyReport] = {}
        self.by_lineage: dict[
            PsychologyReportLineageId, list[CustomerPsychologyReport]
        ] = {}


class InMemoryPsychologyReportRepository:
    """Dict-backed :class:`PsychologyReportRepository`."""
...
class InMemoryUnitOfWork:
    ...
    def __init__(self, storage: ReportStorage) -> None:
        self.reports = InMemoryPsychologyReportRepository(storage)
