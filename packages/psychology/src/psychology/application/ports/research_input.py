"""The Research input port — optional voice-of-customer evidence from Phase 6.

Supplies neutral :class:`RawSignal` s derived from a project's research report. Optional:
a null adapter is valid when no research is available.
"""
