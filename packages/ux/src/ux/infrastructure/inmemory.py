"""In-memory persistence for the UX Strategy Engine.
...
class ReportStorage:
    ...
    def __init__(self) -> None:
        self.by_id: dict[UXReportId, UXStrategyReport] = {}
        self.by_lineage: dict[UXReportLineageId, list[UXStrategyReport]] = {}


class InMemoryUXReportRepository:
    """Dict-backed :class:`UXReportRepository`."""
...
class InMemoryUnitOfWork:
    ...
    def __init__(self, storage: ReportStorage) -> None:
        self.reports = InMemoryUXReportRepository(storage)
